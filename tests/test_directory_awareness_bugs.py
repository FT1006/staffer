        ...
        with pushd(tmp_path):
            ...
            with patch("staffer.available_functions.get_files_info", spy_get_files_info):
                ...
                with patch('staffer.cli.interactive.get_terminal_ui') as mock_get_terminal:
                    ...
                    mock_terminal = mock_terminal_ui(['n', 'explore current directory', 'exit'])
                    mock_get_terminal.return_value = mock_terminal
                    
                    # Also mock builtins.input for directory change prompt
...
# DELETED: test_large_session_directory_context_pollution - expected old pruning behavior
...
# DELETED: test_nested_directory_path_collision_bug - expected old pruning behavior